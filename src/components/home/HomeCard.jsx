...
export default function HomeCard() {
  return (
    <div className="w-[23.288rem] h-auto shrink-0 rounded-lg bg-[#FFF9F1] p-9 font-sans leading-relaxed">
      <div className="h-full flex flex-col justify-between items-start gap-3 ">
        ...
        <div>
          <p className="text-xl font-semibold font-montserrat text-gray-800">
            Lorem ipsum dolor sit amet
          </p>
          <div className="text-gray-600 font-montserrat font-light text-base">
            <p>
